...
DB_PATTERNS: list[tuple[str, str, str, str, re.Pattern]] = [
    ...
    (
        ...
        "phytozome",
        "Bd21",
        re.compile(r"^Bradi[0-9]+g[0-9]+\.[0-9]$", re.IGNORECASE),
    ),
    (
        "plant",
        "brassica_rapa",
    ...
    (
        ...
        "phytozome",
        "",
        re.compile(r"^evm_27\.model\.[A-Za-z0-9_.]+$", re.IGNORECASE),
    ),
    (
        "plant",
        "amborella_trichopoda",
    ...
    (
        ...
        "phytozome",
        "",
        re.compile(r"^Pp3c[0-9]+_[0-9]+V[0-9]+\.[0-9]$", re.IGNORECASE),
    ),
    (
        "plant",
        "physcomitrella_patens",
    ...
    (
        ...
        "tigr",
        "",
        re.compile(r"^\d{5}\.m\d{6}$", re.IGNORECASE),
    ),
    (
        "plant",
        ...
        "phytozome",
        "",
        re.compile(r"^SM[0-9]+$", re.IGNORECASE),
    ),
    (
        "plant",
        "manihot_esculenta",
        "phytozome",
        "",
        re.compile(r"^Manes\.[0-9A-Z]+\.[0-9]$", re.IGNORECASE),
    ),
    (
        "plant",
        "manihot_esculenta",
    ...
    (
        ...
        "phytozome",
        "",
        re.compile(r"^Sobic\.[0-9A-Z]+\.[0-9]$", re.IGNORECASE),
    ),
    (
        "plant",
        "vitis_vinifera",
        "phytozome",
        "Genoscope.12X",
        re.compile(r"^GSVIVT[0-9]+$", re.IGNORECASE),
    ),
    (
        "plant",
        "vitis_vinifera",
...
EMBEDDED_PATTERNS: list[tuple[str, str, str, str, re.Pattern]] = [
    ...
    # ── Phytozome plant genes in lcl_ format ──────────────────
    (
        "plant",
        "zea_mays",
        "maizegdb_legacy",
    ...
    (
        ...
        "phytozome",
        "",
        re.compile(r"(Stub[0-9]+g[0-9]+\.[0-9])", re.IGNORECASE),
    ),
    (
        "plant",
        "solanum_tuberosum",
